        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVariantable = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalReviews = table.Column<int>(type: "int", nullable: false),
                    PriceMin = table.Column<decimal>(type: "decimal(18,4)", nullable: true),
                    PriceMax = table.Column<decimal>(type: "decimal(18,4)", nullable: true),
                    SearchKeywords = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CachedPrimaryImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Weight = table.Column<decimal>(type: "decimal(9,3)", nullable: true),
                    Length = table.Column<decimal>(type: "decimal(9,3)", nullable: true),
                    Width = table.Column<decimal>(type: "decimal(9,3)", nullable: true),
                    Height = table.Column<decimal>(type: "decimal(9,3)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceAtAddition = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "UX_AttributeValues_Attribute_Value",
                table: "AttributeValues",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_ProductVariants_Product_SKU",
                table: "ProductVariants",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VariantAttributeValues_AttributeId_AttributeValueId",
                table: "VariantAttributeValues",
                columns: new[] { "AttributeId", "AttributeValueId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VariantAttributeValues_ProductVariantId_AttributeId",
                table: "VariantAttributeValues",
